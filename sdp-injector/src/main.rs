        ...
        vec![
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        ...
                        Some("default-TestPod0".to_string()),
                    ),
                ],
                service: Service::default(),
                ..Default::default()
            ...
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        "SERVICE_NAME".to_string(),
                        Some("default-TestPod1".to_string()),
                    ),
                ],
                ..Default::default()
            },
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        "SERVICE_NAME".to_string(),
                        Some("default-TestPod2".to_string()),
                    ),
                ],
                ..Default::default()
            },
            ...
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        "SERVICE_NAME".to_string(),
                        Some("default-TestPod4".to_string()),
                    ),
                ],
                ..Default::default()
            },
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        "SERVICE_NAME".to_string(),
                        Some("default-TestPod5".to_string()),
                    ),
                ],
                service: Service {
            ...
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        "SERVICE_NAME".to_string(),
                        Some("default-TestPod6".to_string()),
                    ),
                ],
                ..Default::default()
            },
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        "SERVICE_NAME".to_string(),
                        Some("default-TestPod7".to_string()),
                    ),
                ],
                ..Default::default()
            },
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        "SERVICE_NAME".to_string(),
                        Some("default-TestPod8".to_string()),
                    ),
                ],
                ..Default::default()
            },
            TestPatch {
                ...
                envs: vec![
                    ...
                    (
                        "SERVICE_NAME".to_string(),
                        Some("default-TestPod9".to_string()),
                    ),
                ],
                ..Default::default()
            },
